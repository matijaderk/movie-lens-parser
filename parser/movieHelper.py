...
def parse_file(genre_set, reader, movies_file, movie_genres_file):
    ...
    for row in reader:
        if line_count == 0:
            ...
            movie_genres_list = movie_genres_list + create_movie_genres(movie_id, movie_genres)
...
def parse_files(read_file, movies_file, genres_file, movie_genres_file):
    ...
    line_count, genre_set, movie_genres_list = parse_file(genre_set, reader, movies_file, movie_genres_file)
